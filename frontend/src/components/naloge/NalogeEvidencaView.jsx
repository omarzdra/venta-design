        ...
        <div className="modal-overlay" onClick={() => setViewingDetails(null)}>
          <div className="modal-content animated" onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ marginTop: "2rem", display: "flex", justifyContent: "flex-end", gap: "1rem" }}>
              {viewingDetails.status !== "končana" && (
                <button className="btn-primary" style={{ background: "var(--success)", width: "auto" }} onClick={handleZakljuci}>
                  ✓ ZAKLJUČI NALOGO
                </button>
              )}
